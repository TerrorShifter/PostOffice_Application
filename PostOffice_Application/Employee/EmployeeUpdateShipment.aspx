...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:GridView ID="updateGrid" runat="server" Caption="Updated Shipment" CaptionAlign="Top" CellPadding="7" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
