    ...
    public partial class EmployeeCreateRoute : System.Web.UI.Page
    {
        ...
        protected void InternalSubmit1(object sender, EventArgs e)
        {
            try
            {
                ...
                else if(!Int32.TryParse(TextBox7.Text, out itemp))
                {
                    Label13.Text = "Must be an integer";
                    readyToSubmit = false;
                }
                else if(itemp < 0)
                {
                    Label13.Text = "Cannot be negative";
                    readyToSubmit = false;
                }
                else
        ...
        protected void InternalSubmit2(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Label12.Text = "Must be an integer";
                    readyToSubmit = false;
                }
                else if(itemp < 0)
                {
                    Label12.Text = "Cannot be negative";
                    readyToSubmit = false;
                }
                else
