...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <p style="font-size: medium">
        Employee ID:
        <asp:DropDownList ID="DropDownList11" runat="server" DataSourceID="SqlDataSource9" DataTextField="Employee_ID" DataValueField="Employee_ID" Font-Names="Bodoni MT">
        </asp:DropDownList>
    ...
    <p style="font-size: medium">
        ...
        Address ID(<asp:MultiView ID="MultiView3" runat="server" ActiveViewIndex="1">
            <asp:View ID="View5" runat="server">
                <br />
                Country:
                <asp:DropDownList ID="DropDownList7" runat="server" DataSourceID="SqlDataSource3" DataTextField="Country_Name" DataValueField="Country_ID" Font-Names="Bodoni MT">
                </asp:DropDownList>
                <asp:Label ID="Label11" runat="server"></asp:Label>
                , State:
                <asp:DropDownList ID="DropDownList8" runat="server" DataSourceID="SqlDataSource4" DataTextField="State_Name" DataValueField="State_ID" Font-Names="Bodoni MT">
                </asp:DropDownList>
                , City:
                ...
                <br />
                <asp:Button ID="Button6" runat="server" Text="Submit" OnClick="InternalSubmit3" CssClass="button"/>
                <asp:Button ID="Button7" CommandName="NextView" runat="server" Text="Close" CssClass="button"/>
            </asp:View>
            <asp:View ID="View6" runat="server">
                <asp:Button ID="Button8" CommandName="PrevView" runat="server" Text="Create new" CssClass="button"/>
            </asp:View>
        </asp:MultiView>
        ):
        <asp:DropDownList ID="DropDownList9" runat="server" DataSourceID="SqlDataSource5" DataTextField="Address_ID" DataValueField="Address_ID" Font-Names="Bodoni MT">
        </asp:DropDownList>
    ...
    <p style="font-size: medium">
        Customer ID (<asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="server">
            <asp:View ID="View1" runat="server">
                <asp:Button CommandName="NextView" ID="btnnext" runat="server" Text = "Create new" CssClass="button"/>
            </asp:View>
        ...
        Address ID(<asp:MultiView ID="MultiView2" runat="server" ActiveViewIndex="1">
            <asp:View ID="View3" runat="server">
                <br />
                Country:
                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="Country_Name" DataValueField="Country_ID" Font-Names="Bodoni MT">
                </asp:DropDownList>
                ...
                , State:
                <asp:DropDownList ID="DropDownList4" runat="server" DataSourceID="SqlDataSource4" DataTextField="State_Name" DataValueField="State_ID" Font-Names="Bodoni MT">
                </asp:DropDownList>
                ...
                <br />
                <asp:Button ID="Button2" runat="server" Text="Submit" OnClick="InternalSubmit2" CssClass="button"/>
                <asp:Button ID="Button3" CommandName="NextView" runat="server" Text="Close" CssClass="button"/>
            </asp:View>
            <asp:View ID="View4" runat="server">
                <asp:Button ID="Button4" CommandName="PrevView" runat="server" Text="Create new" CssClass="button"/>
            </asp:View>
        </asp:MultiView>
        ):
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:DropDownList ID="DropDownList5" runat="server" DataSourceID="SqlDataSource5" DataTextField="Address_ID" DataValueField="Address_ID" Font-Names="Bodoni MT">
            </asp:DropDownList>
    ...
    <br />
        Local Post Office ID:
            <asp:DropDownList ID="DropDownList10" runat="server" DataSourceID="SqlDataSource7" DataTextField="Office_Location_ID" DataValueField="Office_Location_ID" Font-Names="Bodoni MT">
            </asp:DropDownList>
    ...
    <br />
        <asp:Button ID="Button5" runat="server" OnClick="InternalSubmit1" Text="Submit" CssClass="button"/>
            <asp:Button ID="Button9" runat="server" CommandName="NextView" Text="Close" CssClass="button"/>
            </asp:View>
        </asp:MultiView>
        ):
        <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="SqlDataSource6" DataTextField="Customer_ID" DataValueField="Customer_ID" Font-Names="Bodoni MT">
        </asp:DropDownList>
    ...
    <p style="font-size: medium">
        Package Type:
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Package_Type_string" DataValueField="Package_Type_ID" Font-Names="Bodoni MT">
        </asp:DropDownList>
    ...
    <p style="font-size: medium">
        Priority:
        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="Priority_Type" DataValueField="Priority_ID" Font-Names="Bodoni MT">
        </asp:DropDownList>
    ...
    <p style="font-size: medium">
        <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="CreateSubmit" CssClass="button"/>
    </p>
</asp:Content>
