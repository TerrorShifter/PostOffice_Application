...
<body style="height: 73px">
    <form id="form1" runat="server">
        ...
        <p style="height: 317px">
            <img class="auto-style1" src="email-png-email-png-285.png" /><asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" BackColor="#E0E0E0" BorderStyle="Groove" ForeColor="Black" Height="36px" OnTextChanged="TextBox1_TextChanged" style="text-align: left; font-size: large; margin-left: 554px; margin-right: 0px; margin-top: 0px; margin-bottom: 1px" Width="328px">Type Your Tracking Number</asp:TextBox>
