...
<body style="height: 73px">
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Button ID="btnLogin" runat="server" Height="31px" OnClick="Login_Click" style="margin-left: 1318px" Text="Log In" Width="79px" />
            <asp:Button ID="btnSignup" runat="server" Height="31px" OnClick="Signup_Click" style="margin-left: 4px" Text="Sign Up" Width="79px" />
        </p>
